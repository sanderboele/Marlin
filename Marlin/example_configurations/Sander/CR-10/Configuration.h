...
#define STRING_CONFIG_H_AUTHOR "Sander's CR-10" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Sander's CR-10"
...
//  of the extruders (uncomment if using more than one and relying on firmware to position when changing).
